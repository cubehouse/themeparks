...
var Park = function () {
    ...
    _createClass(Park, [{
        ...
        key: "SetRideOpeningHours",
        value: function SetRideOpeningHours() {
            var ride = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
        ...
        value: function DateNow() {
            ...
            var _ref2$dateFormat = _ref2.dateFormat;
            var dateFormat = _ref2$dateFormat === undefined ? null : _ref2$dateFormat;
