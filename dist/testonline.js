...
var parks = require("./lib/index").Parks;
    ...
    describe("Get Park Wait Times", function () {
        ...
        it("should have a status field for every ride", function () {
            for (var i = 0, ride; ride = times[i++];) {
                ...
                assert(ride.status == "Operating" || ride.status == "Refurbishment" || ride.status == "Closed", "Invalid status string returned by " + ride.name + ": " + ride.status);
            }
        });
