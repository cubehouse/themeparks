                ...
                this.GetAPIUrl({
                    ...
                    function(waitTimeData) {
                        ...
                        for (var i = 0, ride; ride = waitTimeData.entries[i++];) {
                            ...
                            // set new wait time
                            //  FIX: some rides don't have postedWaitMinutes, but are still operating (of course...)
                            //   so check for "Operating" status and assume wait time zero
                            rideObject.WaitTime = ride.waitTime.postedWaitMinutes || (ride.waitTime.status == "Operating" ? 0 : -1);
