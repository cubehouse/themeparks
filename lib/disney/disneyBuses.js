                ...
                if (this[s_Channel] === undefined) {
                    ...
                    return this.GetChannelNames().then((channels) => {
                        ...
                        this[s_Channel] = new couchbaseChannelDisney({
                            ...
                            longpoll: false // important! bus data updates *CONSTANTLY*, so we'll poll for it rather than get live updates
                        });
                        ...
                        this[s_Channel].Start().then(() => {
                            this.Log("Got initial state, begin occasional polling");

                            const Poll = () => {
                                this[s_Channel].Poll().then(() => {
                                    setTimeout(Poll, this[s_PollInterval] * 1000);
                                }).catch(() => {
                                    setTimeout(Poll, this[s_PollInterval] * 1000);
                                });
                            };
