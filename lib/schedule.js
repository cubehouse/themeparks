...
class Schedule {
     ...
     * @param {String} [scheduleData.type=Operating] The schedule type. Normal schedules should always be "Operating" or "Closed". Special schedules can be any String (eg. Extra Magic Hours).
    ...
    SetDate({
        ...
        if (!specialHours) {
            ...
            if (type != "Operating" && type != "Closed") {
                Log(`Tried to use invalid schedule type ${type} for standard schedule data (must be Operating or Closed)`);
                return false;
            }
