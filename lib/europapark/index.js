...
class EuropaPark extends Park {
    ...
    constructor(options = {}) {
        ...
        this[s_apiVersion] = options.api_version || "api-5.6";
            ...
            return new Promise(function (resolve, reject) {
                ...
                this.HTTP({
                    ...
                    for (var i = 0, poi; poi = ride_data[i++];) {
                        ...
                        if (poi.name) { // api-5.9
                            poiNameFound = poi.name.find(function (langArr) {
                                return langArr.language === "en";
                            });
                            enName = (typeof poiNameFound !== undefined ? poiNameFound.value : null);
                            poiNameFound = poi.name.find(function (langArr) {
                                return langArr.language === "de";
                            });
                            deName = (typeof poiNameFound !== undefined ? poiNameFound.value : null);
                        } else { // api-5.6
                            enName = poi.nameEnglish;
                            deName = poi.nameGerman;
                        }

                        rideNames[poi.code] = enName || deName || "???";
                    }
