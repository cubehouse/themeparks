...
class Ride {
    ...
    constructor(options = {
        ...
        this[s_rideThrill] = options.ride_thrill;
    ...
    fromJSON(rideData) {
        ...
        this[s_rideThrill] = rideData.thrill
    ...
    set Thrill(value) {
        if (this[s_rideThrill] === undefined || this[s_rideThrill] != value) {
            this[s_rideThrill] = value;
        }
    ...
    get Thrill() {
        // always return positive ints for the wait time, even when inactive or not defined yet
        if (this[s_rideThrill] === undefined || this[s_rideThrill] < 0) return 0;

        return this[s_rideThrill];
    }
