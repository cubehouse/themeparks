...
class WaltDisneyWorldPark extends Park {
  ...
  get FetchWaitTimesURL() {
    ...
    return `${api_baseURL}theme-parks/${this[s_disneyAPIParkID]};destination\u003d${this[s_disneyAPIResortID]}/wait-times`;
  }

  /**
   * Setup offline tests for testing WDW API
   */
  SetupOfflineTests() {
    var nock = require("nock");

    // access token intercept
    nock("https://authorization.go.com").post("/token").reply(200, {
